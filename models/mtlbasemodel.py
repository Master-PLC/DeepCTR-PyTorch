...
# -*- encoding: utf-8 -*-
'''
@File         :mtlbasemodel.py
@Description  :
@Date         :2021/10/15 15:51:45
...
from deepctr_torch.inputs import build_input_features, SparseFeat, DenseFeat, VarLenSparseFeat, \
...
class MTLBaseModel(nn.Module):
    def __init__(self,
                 dnn_feature_columns,
                 expert_dnn_hidden_units: Optional[Union[Tuple, List]] = (256, 128),
                 tower_dnn_hidden_units: Optional[Union[Tuple, List]] = (64,),
                 gate_dnn_hidden_units: Optional[Union[Tuple, List]] = (),
        ...
        super(MTLBaseModel, self).__init__()
        ...
        self.feature_index = build_input_features(dnn_feature_columns)
        self.dnn_feature_columns = dnn_feature_columns
    ...
    def fit(self, x=None, y=None, batch_size=None, epochs=1, verbose=1, initial_epoch=0, validation_split=0.,
        ...
        if self.gpus:
            ...
            # input `batch_size` is batch_size per gpu
